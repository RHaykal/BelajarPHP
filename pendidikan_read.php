...
try {
    ...
    if ($filter) {
        if (isset($filter->nama_pendidikan)) {
            $filterConditions[] = "nama_pendidikan LIKE :nama_pendidikan";
        }
    ...
    if ($filter) {
        if (isset($filter->nama_pendidikan)) {
            $nama_pendidikan = '%' . $filter->nama_pendidikan . '%';
            $stmt->bindParam(':nama_pendidikan', $nama_pendidikan, PDO::PARAM_STR);
        }
    ...
    $totalCountQuery = "SELECT COUNT(*) FROM pendidikan";
