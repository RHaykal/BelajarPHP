...
try {
    ...
    $query = "UPDATE barang_bukti_kasus SET is_deleted = 1 WHERE barang_bukti_kasus_id = :barang_bukti_kasus_id";
    $stmt = $conn->prepare($query);
    $stmt->bindParam(':barang_bukti_kasus_id', $barang_bukti_kasus_id);
    $stmt->execute();
