...
try {
    ...
    if ($filter) {
        if (isset($filter->nama_status_kawin)) {
            $filterConditions[] = "nama_status_kawin LIKE :nama_status_kawin";
        }
    ...
    $query = "SELECT * FROM status_kawin";
    ...
    if ($filter) {
        if (isset($filter->nama_status_kawin)) {
            $nama_status_kawin = '%' . $filter->nama_status_kawin . '%';
            $stmt->bindParam(':nama_status_kawin', $nama_status_kawin, PDO::PARAM_STR);
        }
    ...
    $totalCountQuery = "SELECT COUNT(*) FROM status_kawin";
