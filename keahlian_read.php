...
try {
    ...
    $pageSize = isset($request_data->pageSize) ? (int) $request_data->pageSize : 1000; // Number of records per page
    ...
    if ($filter) {
        if (isset($filter->nama_bidang_keahlian)) {
            $filterConditions[] = "nama_bidang_keahlian LIKE :nama_bidang_keahlian";
        }
    ...
    $query = "SELECT * FROM bidang_keahlian";
    ...
    if ($filter) {
        if (isset($filter->nama_bidang_keahlian)) {
            $nama_bidang_keahlian = '%' . $filter->nama_bidang_keahlian . '%';
            $stmt->bindParam(':nama_bidang_keahlian', $nama_bidang_keahlian, PDO::PARAM_STR);
        }
    ...
    $totalCountQuery = "SELECT COUNT(*) FROM bidang_keahlian";
